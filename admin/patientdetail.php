							...
							<div class="card">
								...
								<table class="table table-bordered">
										...
										<tr>
											...
											<td style="width:25%"><?php echo $rspatient['patientname']; ?></td>
											<th class="d-none d-md-table-cell" style="width:25%">Patient ID</th>
											<td class="d-none d-md-table-cell" style="width:25%"><?php echo $rspatient['patientid']; ?></td>
											
										</tr>
										<tr>
											<th style="width:40%;">Address</th>
											<td style="width:25%"><?php echo $rspatient['address']; ?></td>
											<th class="d-none d-md-table-cell" style="width:25%">Gender</th>
											<td class="d-none d-md-table-cell" style="width:25%"><?php echo $rspatient['gender'];?></td>
											
										</tr>
										<tr>
											<th style="width:40%;">Contact Number</th>
											<td style="width:25%"><?php echo $rspatient['mobileno']; ?></td>
											<th class="d-none d-md-table-cell" style="width:25%">Date Of Birth</th>
											<td class="d-none d-md-table-cell" style="width:25%"><?php echo $rspatient['dob']; ?></td>
