	...
	<div class="wrapper">
			...
			<main class="content">
				<div class="container-fluid p-0">
					<div class="row mb-2 mb-xl-3">
							...
							<h3><strong>Admin Account</strong> Appointment</h3>
						</div>

						<div class="col-auto ml-auto text-right mt-n1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
									<li class="breadcrumb-item"><a href="#">Pending Appointmtnt</a></li>
                 	...
                 	<div class="col-12 col-xl-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title text-center">View Pending Appointmtnt</h5>
        ...
        echo "<tr>
		  ...
		  if($rs[status] != "Approved")
		  {
				 ...
				 echo "  <a href='viewappointmentpending.php?delid=$rs[appointmentid]'>Delete</a>";
		  }
		  else
		  {
