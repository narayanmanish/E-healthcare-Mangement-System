							...
							<div class="card">
								...
								<table class="table table-bordered">
										...
										<tr>
											...
											<td style="width:25%"><?php echo $_GET[appointmentid]; ?></td>
											
										</tr>
										<tr>
											<th style="width:40%;">Department</th>
											<td style="width:25%"><?php echo $rsdepartment[departmentname]; ?></td>
											
										</tr>
										<tr>
											<th style="width:40%;">Doctor</th>
											<td style="width:25%"><?php echo $rsdoctor[doctorname]; ?></td>
											
										</tr>
										<tr>
											<th style="width:40%;">Appointment Date</th>
											<td style="width:25%"><?php echo date("d-M-Y",strtotime($rsappointment[appointmentdate])); ?></td>
											
										</tr>
										<tr>
											<th style="width:40%;">Appointment Time</th>
											<td style="width:25%"><?php echo date("h:i A",strtotime($rsappointment[appointmenttime])); ?></td>
