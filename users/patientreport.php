	...
	<div class="wrapper">
		...
		<div class="main">
            ...
            <div class="col-auto d-none d-sm-block">
              <h3><strong>Patient Account</strong> Report</h3>
            </div>
            ...
            <div class="col-auto ml-auto text-right mt-n1">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="#">Appointmtnt</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Report</li>
					...
					<div class="card">
						<div class="card-header">
							...
							<h6 class="card-subtitle text-muted text-center">Patient Report</h6>
						</div>
						<div class="card-body">
							<div class="row">
