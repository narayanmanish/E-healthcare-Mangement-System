...
{
	$sql ="DELETE FROM appointment WHERE appointmentid='$_GET[delid1]'";
	...
	<div class="wrapper">
        ...
        echo "<tr>
		  ...
		  if($rs[status] != "Approved")
		  {
				 ...
				 echo "  <a href='viewappointment.php?delid1=$rs[appointmentid]'><i class='align-middle' data-feather='trash'></i></a>";
		  }
		  else
		  {
